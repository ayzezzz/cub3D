...
static void calculate_distance(t_data *data)
{
    ...
    {
        data->rayc->side_x = (data->player.p_x - data->rayc->map_x) * data->rayc->delta_x;
        data->rayc->step_x = -1;
    }
    else
    {
        data->rayc->step_x = 1;
        data->rayc->side_x = (data->rayc->map_x + 1.0 - data->player.p_x) * data->rayc->delta_x;
    }
    if (data->rayc->ray_dir_y < 0)
    {
        data->rayc->side_y = (data->player.p_y - data->rayc->map_y) * data->rayc->delta_y;
        data->rayc->step_y = -1;
    }
    else
    {
        data->rayc->step_y = 1;
        data->rayc->side_y = (data->rayc->map_y + 1.0 - data->player.p_y) * data->rayc->delta_y;
    }
}
